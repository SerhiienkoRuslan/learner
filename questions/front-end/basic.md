...
- Cookies - є невеликими фрагментами даних, які зберігаються на пристрої користувача веб-сайту. Вони використовуються для зберігання інформації про взаємодію користувача з веб-сайтом, таку як логін, товари в кошику та налаштування.
